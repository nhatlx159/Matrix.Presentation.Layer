...
function YouMightLike(props) {
    ...
    const sliderEffect = () => {
        if ($('.slider-2').scrollLeft() != null && location.pathname == "/") {
            $(document).ready(function () {
                let scrollInterval;
                $('.prev-button-2').click(function () {
                    let slider = $('.slider-2');
                    let scrollAmount = slider.find('.product-card-yml').first().outerWidth(); // Chiều rộng của sản phẩm
    ...
    return (
        <div className="for-you">
            <div className="slider-2">
                <div className="product-card product-card-yml" onClick={redirectToDetails}>
